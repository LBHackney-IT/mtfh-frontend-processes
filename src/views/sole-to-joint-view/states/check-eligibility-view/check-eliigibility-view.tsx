...
export const CheckEligibilityView = ({
  ...
  const { automatedChecksFailed, automatedChecksPassed, manualChecksFailed } =
            ...
            {state === manualChecksFailed.state && (
              <>
                <Box variant="warning">
                  <StatusHeading
                    variant="warning"
                    title={checkEligibility.failedChecks}
                  />{" "}
                  <div style={{ marginLeft: "60px" }}>
                    <Text size="sm">
                      All criteria must be passed in order for the applicant to be
                      eligible. <br />
                      Applicant has failed one or more of the further eligibility
                      questions:
                    </Text>
                    <Heading variant="h5">Failed further eligibility question:</Heading>
                    <List variant="bullets">
                      <Text size="sm">
                        The tenant and proposed tenant have not been living together for
                        12 months or more, or are not married or in a civil partnership
                      </Text>
                      <Text size="sm">
                        The tenant or proposed tenant intends to occupy another property
                        as their only or main home
                      </Text>
                      <Text size="sm">Then tenant is a survivor of a joint tenancy</Text>
                      <Text size="sm">
                        The proposed tenant has been evicted by London Borough of Hackney
                        or another local authority or housing association
                      </Text>
                      <Text size="sm">
